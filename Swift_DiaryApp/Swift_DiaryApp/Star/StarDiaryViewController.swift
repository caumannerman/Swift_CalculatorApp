...
final class StarDiaryViewController: UIViewController {
    //즐겨찾기 된 다이어리만들 담을 리스트
    ...
    private func loadStaredDiaryList(){
        ...
        guard let data = UserDefaults.standard.object(forKey: "diaryList") as? [[String: Any]] else { return }
...
extension StarDiaryViewController{
    func setupLayout(){
...
extension StarDiaryViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setup( diary.title,self.dateToString(diary.date))
